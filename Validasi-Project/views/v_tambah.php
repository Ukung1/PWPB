...
<body>
Mohon Masukan Nama Lengkap Dengan Benar
    ...
    <form method="POST" action="<?= $action ?>" class="formz "enctype="multipart/form-data">
        ...
        <div>
            ...
            <input type="text" placeholder="Masukan Nama Lengkap Siswa" name="nama" value="<?= @$siswa['nama'] ?>" >
        </div>
        <div>
            <label>
            <span>Jenis kelamin :</span><br>
            <input type="radio" name="gender" value="L" <?= @$siswa['gender'] == 'L' ? 'checked' : '' ?> > Laki-laki
            </label>
            <label>
        ...
        <div>
            <div>
                ...
                <input type="text" placeholder="Masukkan Nama Ibu Kandung anda" name="ibukandung" value="<?= @$siswa['ibukandung']; ?>" >
        </div>
